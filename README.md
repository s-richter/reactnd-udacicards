...
* the "Quiz" screen allows the user to do a quiz. The view can be switched between the question and the answer. The user than has to click on "Correct" or "Incorrect", depending on whether he or shs answered correctly. Once the quiz is over, the results are shown and the quiz can be restarted.
...
1. run `https://github.com/s-richter/reactnd-udacicards` to clone the repository
...
* [create-react-native-app](https://github.com/react-community/create-react-native-app) - *template for react native apps* - by the React NAtive team team
